...
class _MobileRecordingSheetState extends State<MobileRecordingSheet>
  ...
  Future<void> _startRecording() async {
    ...
    if (!Platform.isWindows) {
      ...
      if (status != PermissionStatus.granted) {
        if (mounted) {
          ToastService.showError(context, "Permiso de micrófono denegado");
        ...
        children: [
          ...
          Stack(
            ...
            children: [
              ...
              ScaleTransition(
                scale: _state == RecorderState.recording
                    ? _pulseAnimation
            ...
            children: [
              ...
              IconButton(
                onPressed: () => Navigator.pop(
                    context), // Cancel discards? Or we should delete?
